      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 sm:p-8 shadow-2xl">
          ...
          {activeTab === "result" && (
            <form onSubmit={handleResultSubmit} className="space-y-5">
              <h2 className="text-sm font-bold uppercase tracking-wider flex items-center gap-2 text-zinc-100 border-b border-zinc-800 pb-3">
                <FileText className="w-4 h-4 text-zinc-400" /> Publish Result by
                Student Roll
              </h2>
          ...
          {/* ========== ALL RESULTS TAB (View / Edit / Delete) ========== */}
          {activeTab === "results" && (
            <div className="space-y-6">
              <h2 className="text-sm font-bold uppercase tracking-wider flex items-center gap-2 text-zinc-100 border-b border-zinc-800 pb-3">
                <FileText className="w-4 h-4 text-zinc-400" /> All Results (
                {results.length})
              </h2>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full bg-zinc-900 border border-zinc-700 rounded-xl px-3 py-2 text-xs"
                                required
                              />
                            </div>
                            <div>
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                          <div className="space-y-1">
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              <span className="text-[10px] bg-zinc-900 border border-zinc-700 px-2 py-0.5 rounded-lg">
          ...
          {activeTab === "students" && (
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-b border-zinc-800 pb-4">
                <h2 className="text-sm font-bold uppercase tracking-wider flex items-center gap-2 text-zinc-100">
                  <Users className="w-4 h-4 text-zinc-400" /> Enrolled Students
          ...
          {activeTab === "admins" && (
            <div className="space-y-4">
              <h2 className="text-sm font-bold uppercase tracking-wider flex items-center gap-2 text-zinc-100 border-b border-zinc-800 pb-3">
                <Shield className="w-4 h-4 text-zinc-400" /> Admin Directory (
                {admins.length})
              </h2>
