                            ...
                            >
                              <div className="flex items-center justify-between gap-1">
                                ...
                                <div className="flex items-center gap-1 flex-shrink-0">
                                  ...
                                  <span className={`px-1.5 py-0.5 rounded text-[9px] font-semibold flex items-center gap-0.5 border ${
                                    isPassed 
                                  ...
                                  {position && (
                                    <span className="bg-amber-500/10 border border-amber-500/20 text-amber-400 font-semibold px-1.5 py-0.5 rounded text-[9px] flex items-center gap-0.5">
                                      <Trophy className="w-2.5 h-2.5" /> #{position}
                                    </span>
                                  )}

                                 
                                  <span className="bg-violet-600/10 border border-violet-500/20 text-violet-400 font-semibold px-1.5 py-0.5 rounded text-[9px]">
                                    Tot: {total}
                                  </span>
                                </div>
                              </div>
